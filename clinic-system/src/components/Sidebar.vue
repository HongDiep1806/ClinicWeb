                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                                <span class="avatar rounded-circle flex-shrink-0 p-2"><img
                                        src="/img/icons/trustcare.svg" alt="img"></span>
                                <div class="ms-2">
                        ...
                        <div class="p-2">
                            <label class="dropdown-item d-flex align-items-center justify-content-between p-1">
                                <span class="d-flex align-items-center">
                                    <span class="me-2"><img src="/img/icons/clinic-01.svg" alt=""></span>
                            ...
                            <label class="dropdown-item d-flex align-items-center justify-content-between p-1">
                                <span class="d-flex align-items-center">
                                    <span class="me-2"><img src="/img/icons/clinic-02.svg" alt=""></span>
                            ...
                            <label class="dropdown-item d-flex align-items-center justify-content-between p-1">
                                <span class="d-flex align-items-center">
                                    <span class="me-2"><img src="/img/icons/clinic-03.svg" alt=""></span>
                            ...
                            <label class="dropdown-item d-flex align-items-center justify-content-between p-1">
                                <span class="d-flex align-items-center">
                                    <span class="me-2"><img src="/img/icons/clinic-04.svg" alt=""></span>
                    ...
                    <li>
                        <ul>
                            ...
                            <li v-else-if="role==null">
                                <router-link to="/notfound-404">Default Dashboard</router-link>
                            </li>
                        ...
                        <ul>
                            <li class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li><router-link to="/add-doctor">Add Doctor</router-link></li>
                                    <li><router-link to="/doctor-schedule">Doctor Schedule</router-link></li>
                                </ul>
                            </li>
                            <li class="submenu">
                                <a href="javascript:void(0);">
...
export default {
  ...
  data() {
    return {
      role: '', // lưu role để render menu
    }
  },
  mounted() {
    const authStore = useAuthStore()

    // ✅ Lấy thông tin role từ store Pinia (đã lưu khi login)
    this.role = authStore.user?.role || 'Guest'

    // ✅ Gọi lại script theme sau khi sidebar render xong
    ...
    // ✅ Xử lý toggle menu (jQuery từ theme)
    if (window.$) {
      const $ = window.$
      ...
      console.warn('⚠️ jQuery not found. Make sure theme-script.js is loaded.')
    }
  },
}
</script>
