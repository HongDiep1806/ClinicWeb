                ...
                <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2 pb-3 mb-3 border-1 border-bottom">
                    ...
                    <div class="text-end d-flex">
                        ...
                        <div class="bg-white border shadow-sm rounded px-1 pb-0 text-center d-flex align-items-center justify-content-center">
                            <a href="patient-appointments.html" class="bg-light rounded p-1 d-flex align-items-center justify-content-center"> <i class="ti ti-list fs-14 text-dark"></i></a>
                            <a href="patient-appointment-details.html" class="bg-white rounded p-1 d-flex align-items-center justify-content-center"> <i class="ti ti-calendar-event fs-14 text-body"></i> </a>
                        </div>
                        ...
                        <tbody>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="patients-doctor-details.html" class="avatar avatar-md me-2">
                                            <img src="/img/doctors/doctor-01.jpg" alt="product" class="rounded-circle">
                                        </a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="patients-doctor-details.html" class="avatar avatar-md me-2">
                                            <img src="/img/doctors/doctor-02.jpg" alt="product" class="rounded-circle">
                                        </a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="patients-doctor-details.html" class="avatar avatar-md me-2">
                                            <img src="/img/doctors/doctor-03.jpg" alt="product" class="rounded-circle">
                                        </a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="patients-doctor-details.html" class="avatar avatar-md me-2">
                                            <img src="/img/doctors/doctor-04.jpg" alt="product" class="rounded-circle">
                                        </a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="patients-doctor-details.html" class="avatar avatar-md me-2">
                                            <img src="/img/doctors/doctor-05.jpg" alt="product" class="rounded-circle">
                                        </a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="patients-doctor-details.html" class="avatar avatar-md me-2">
                                            <img src="/img/doctors/doctor-06.jpg" alt="product" class="rounded-circle">
                                        </a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="patients-doctor-details.html" class="avatar avatar-md me-2">
                                            <img src="/img/doctors/doctor-07.jpg" alt="product" class="rounded-circle">
                                        </a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="patients-doctor-details.html" class="avatar avatar-md me-2">
                                            <img src="/img/doctors/doctor-08.jpg" alt="product" class="rounded-circle">
                                        </a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="patients-doctor-details.html" class="avatar avatar-md me-2">
                                            <img src="/img/doctors/doctor-10.jpg" alt="product" class="rounded-circle">
                                        </a>
