                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex gap-2 flex-wrap mb-3">
                            <button v-for="d in days" :key="d" class="btn"
                                :class="activeDay === d ? 'btn-primary' : 'btn-light'" :disabled="schedules[d]?.locked"
                                @click="activeDay = d">
                                {{ d }}
                            </button>
                        </div>

                        <p v-if="schedules[activeDay]?.locked" class="text-danger fw-semibold">
                            ⚠ This day has confirmed appointments and cannot be modified.
                        </p>


                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" v-model="schedules[activeDay].isAssigned"
                                :disabled="schedules[activeDay].locked" />
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" value="Morning"
                                    ...
                                    :disabled="!schedules[activeDay].isAssigned || schedules[activeDay].locked" />
                                Morning (08:00 - 12:00)
                            </div>
                            <div class="form-check">
