            ...
            <div class="modal-dialog modal-dialog-centered modal-md modal-dialog-scrollable">
                <div class="modal-content p-3">
                    ...
                    <div class="modal-body">
                        ...
                        <!-- WARNING -->
                        <p v-if="isDayLocked(activeDay)" class="text-danger fw-semibold">
                            ⚠ This day has appointments. You cannot modify the schedule. Please check the appointments.
                        </p>

                        <!-- ASSIGNED -->
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" :checked="schedules[activeDay].isAssigned"
                                :disabled="isDayLocked(activeDay)" @change="onToggleAssigned($event)" />
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" value="Morning"
                                    ...
                                    :disabled="!schedules[activeDay].isAssigned || isDayLocked(activeDay)" />
                                Morning (08:00 - 12:00)
                            </div>
...
export default {
    ...
    methods: {
        ...
        onToggleAssigned(e) {
            if (this.isDayLocked(this.activeDay)) {
                // rollback UI
                e.target.checked = true;

                this.$toast?.error?.(
                    "This day has confirmed appointments and cannot be turned off"
                );

                return;
            }

            this.schedules[this.activeDay].isAssigned = e.target.checked;
        },
        ...
        isDayLocked(day) {
            return this.hasConfirmedFutureAppointmentForDay(
        ...
        async saveAllSchedules() {
            ...
            for (let day of this.days) {
                ...
                if (!item.isAssigned && this.isDayLocked(day)) {
                    toast.error(
