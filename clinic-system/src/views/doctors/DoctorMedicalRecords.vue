                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr v-else v-for="r in paginatedRecords" :key="r.medicalRecordId">
                                        ...
                                        <td>
                                            ...
                                            <span v-for="p in r.prescriptions.slice(0, 2)" :key="p.prescriptionId"
                                            ...
                                            <span v-if="r.prescriptions.length > 2" class="text-muted small">
