                        ...
                        <div class="mb-4 pb-3 border-bottom">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="avatar-circle-large me-3"
                                    :style="{ backgroundColor: getColor(form.fullName) }">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="password-wrapper">
                                            <input :type="show.current ? 'text' : 'password'" v-model="password.current"
                                                class="form-control" />
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="password-wrapper">
                                            <input :type="show.new ? 'text' : 'password'" v-model="password.new"
                                                class="form-control" />
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="password-wrapper">
                                            <input :type="show.confirm ? 'text' : 'password'" v-model="password.confirm"
                                                class="form-control" />
...
export default {
    components: { NavbarPatient, SidebarPatient, VueDatePicker },
    ...
    methods: {
        ...
        onProvinceChange() {
            const province = this.provinces.find(
                p => String(p.matinhBNV) === String(this.selectedProvince)
            )
        ...
        buildAddress() {
            if (!this.selectedProvince && !this.selectedWard) return this.form.address;

            if (!this.selectedProvince || !this.selectedWard) return null;
        ...
        async saveProfile() {
            ...
            if (address === null) return toast.error("Please select BOTH province and ward.");

            try {
                await updateUser(this.auth.user.userId, {
                    ...this.form,
                    dob: this.formatDateLocal(this.dobModel),
                    address
                });
