        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="d-flex align-items-center justify-content-between mb-3 pb-3 border-bottom">
                    ...
                    <router-link to="/receptionist/add-patient" class="btn btn-primary fs-13">
                ...
                <div class="d-flex gap-2 mb-3">
                    <input v-model="searchText" type="text" class="form-control w-auto"
                        placeholder="Search patient..." style="max-width: 250px;" />
                            ...
                            <tr v-for="p in paginatedPatients" :key="p.userId">
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        <!-- View -->
                                        <button class="btn btn-sm btn-light border" title="View"
                                            @click="openView(p)">
                                            <i class="ti ti-eye"></i>
                                        </button>

                                        <!-- Edit -->
                                        <router-link :to="`/receptionist/edit-patient/${p.userId}`"
...
export default {
    ...
    components: { NavbarReceptionist, SidebarReceptionist },
