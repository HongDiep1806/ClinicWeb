  ...
  <div class="main-wrapper">
    ...
    <div class="page-wrapper">
                ...
                <form @submit.prevent="handleSubmit">
                  ...
                  <div class="mb-3">
                    ...
                    <small class="text-muted">
                      Password will be given to patient for first login.
                    </small>
                  ...
                  <div class="alert alert-info mt-3">
                    Receptionist creates patient accounts. Patients use this account to log in.
                  </div>
      ...
      <div class="footer text-center bg-white p-2 border-top">
        <p class="text-dark mb-0">2025 © Clinic Management System</p>
      </div>
    </div>
  </div>
</template>
...
export default {
  components: { SidebarReceptionist, NavbarReceptionist, VueDatePicker },
  ...
  methods: {
    ...
    async handleSubmit() {
      ...
      if (!this.form.fullName || !this.form.email || !this.form.password ||
        !this.confirmPassword || !this.form.phone || !this.dobModel ||
        !this.form.gender || !this.selectedProvince || !this.selectedWard) {
      ...
      if (new Date(this.dobModel) >= new Date()) {
      ...
      try {
        ...
        else if (raw.includes("Role is required")) {
          toast.error("System error: missing roleId")
        }
        else if (raw.includes("Date of birth must be in the past")) {
